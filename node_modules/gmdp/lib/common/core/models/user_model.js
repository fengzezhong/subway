...
var userListSchema=new Schema(
    {   user_no: String,
        ...
        user_email: String,
        user_status: Number,
        user_org: Schema.Types.ObjectId,
        user_sys: Schema.Types.ObjectId,
        user_roles: [Schema.Types.ObjectId],
        user_photo: String,
        __v: String },
    {collection: "common_user_info"}
);
exports.$userListModel = mongoose.model('userListModel', userListSchema);
