...
module.exports = function(grunt) {    
    ...
    grunt.registerTask('writeIndex', function() {
        ...
        grunt.file.write("dist/index.html", "<!doctype html><html><head><meta http-equiv='refresh' content='0;url=demo/subway/jquery.html'/></head></html>");
        // write an index file to the root of the docs dir (redirects to 'subway')
        grunt.file.write("dist/doc/index.html", "<!doctype html><html><head><meta http-equiv='refresh' content='0;url=subway'/></head></html>");
    });
    ...
    // reads the contents of subway.html (the docs index), and writes it into all of the other files.
